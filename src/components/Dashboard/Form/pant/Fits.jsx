...
const regularChart = [
  {
    ...
    sizes: [94, 97, 100, 103, 106],
  },
  {
    id: "B",
    description: "Waistband Stretched",
    sizes: [40, 43, 46, 49, 52],
  },
  {
    id: "C",
  ...
  {
    id: "F",
    description: "Leg Opening Elastic",
...
const Fits = ({ handleNext }) => {
  const [fitChoice, setFitChoice] = useState("Straight leg");
  ...
  useEffect(() => {
    const getDetails = async () => {
      ...
      try {
        ...
        setFitChoice(data.fit_type ? data.fit_type : "Straight leg");
    ...
    <div>
      {isLoading ? (
        ...
        <div className="flex flex-col xl:flex-row gap-4">
          <ChooseFit
            fitChoice={fitChoice}
            choices={["Straight leg", "Baggy fit", "Custom fit"]}
          ...
          {fitChoice !== "Custom fit" ? (
            <SizeChart
              ...
              sizes={["XS", "S", "M", "L", "XL"]}
              img={
                "https://drive.google.com/file/d/1LPtGXtBg9ctH6cfUd5dC0sVzYBXH5Yl6/view?usp=drive_link"
              }
            />
          ) : (
            <CustomChart
