  ...
  return (
    <div className="w-full mt-4 mb-16">
      ...
      {activeSideNav === "Design" && (
        <Customize
          imgs={[
            "https://drive.google.com/file/d/1pReBD4kIlwKoY2ZraZMmLjDuAcrxoriq/view?usp=drive_link",
            "https://drive.google.com/file/d/1N6V19HvWeXfCYV-h-sAav4Yv7bjtOKRP/view?usp=drive_link",
          ]}
          handleNext={handleNext}
        />
      )}
