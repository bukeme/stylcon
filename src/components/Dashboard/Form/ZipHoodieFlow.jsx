...
import Fits from "./zip-hoodie/Fits";
  ...
  return (
    <div className="w-full mt-4 mb-16">
      ...
      {activeSideNav === "Neck label" && (
        <NeckLabel
          img={
            "https://drive.google.com/file/d/1iw77KdxTpf9MgSYWKW9ZYdO41a1Llsav/view?usp=drive_link"
          }
          handleNext={handleNext}
        />
      )}
      ...
      {activeSideNav === "Design" && (
        <Customize
          imgs={[
            "https://drive.google.com/file/d/1Bpa5Kym87SdXOHOKt-lomUUDJqi6fHCt/view?usp=drive_link",
            "https://drive.google.com/file/d/1Venx1DgXI6WaF4L4bkXc3Q29g7fTNGlb/view?usp=drive_link",
          ]}
          handleNext={handleNext}
        />
      )}
      {activeSideNav === "Cloth Design" && (
        <ClothDesign
          options={[
            {
              name: "Regular",
              img: "https://drive.google.com/file/d/1CE8doyKwqV17VENJ6xr1dB86NMHQoKWH/view?usp=drive_link",
            },
            {
              name: "Color wash",
              img: "https://drive.google.com/file/d/1ZjiwCyqcpJqMPOHzoEWSJ0wvIfZhZxFo/view?usp=drive_link",
            },
          ]}
          handleNext={handleNext}
        />
