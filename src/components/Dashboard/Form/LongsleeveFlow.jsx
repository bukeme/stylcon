  ...
  return (
    <div className="w-full mt-4 mb-16">
      ...
      {activeSideNav === "Design" && (
        <Customize
          imgs={[
            "https://drive.google.com/file/d/1DaPPZZtTBgmBUmKpoZ3sHf-qAXaRtGX-/view?usp=drive_link",
            "https://drive.google.com/file/d/1NiwjhJrPiokeqqU7RkTMjjYdUBHfa-Nq/view?usp=drive_link",
          ]}
          handleNext={handleNext}
        />
      )}
      {activeSideNav === "Cloth Design" && (
        <ClothDesign
          options={[
            {
              name: "Regular",
              img: "https://drive.google.com/file/d/1mCBgi1Kk1ZVnqpfDLWcCRk9ZhfDBKFzH/view?usp=drive_link",
            },
            {
              name: "Color wash",
              img: "https://drive.google.com/file/d/1aGWLXCZwt615FLUBQm7j8h7Kv6pwaQ3E/view?usp=drive_link",
            },
          ]}
          handleNext={handleNext}
        />
