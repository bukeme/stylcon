...
import Fits from "./sweat-pant/Fits";
  ...
  return (
    <div className="w-full mt-4 mb-16">
      ...
      {activeSideNav === "Design" && (
        <Customize
          imgs={[
            "https://drive.google.com/file/d/1AHJPTyaTUvsPhuvoLaQxw73KVTxvy-v7/view?usp=drive_link",
            "https://drive.google.com/file/d/1VabGWNLKNox72N1RruzE1AbHFj1Eq6TU/view?usp=drive_link",
          ]}
          handleNext={handleNext}
        />
      )}
