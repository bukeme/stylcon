...
const regularFit = [
  ...
  },
  {
    ...
    sizes: [17, 18, 19, 23, 24, 25, 26],
  },
  {
    id: "E",
    description: "Armhole",
    sizes: [21, 22, 23, 25, 25.5, 26, 26.5],
  },
  {
    id: "F",
    description: "Sleeve Opening",
    sizes: [15.5, 16, 16.5, 22, 22.5, 23, 23.5],
  },
  {
    id: "G",
...
const boxyFit = [
  ...
  },
  {
    id: "F",
    description: "Sleeve Opening",
    sizes: [20.5, 21, 21.5, 22, 22.5, 23, 23.5],
  },
  {
    id: "G",
    description: "Neck Rib Length",
    ...
    <div>
      {isLoading ? (
        ...
        <div className="flex flex-col xl:flex-row gap-4">
          <ChooseFit
            fitChoice={fitChoice}
            choices={["Regular fit", "Boxy fit", "Crop fit", "Custom fit"]}
          ...
          {fitChoice !== "Custom fit" ? (
            <SizeChart
              ...
              img={
                "https://drive.google.com/file/d/1oW4OBd23xzby4EkV_uLwzvML5w1J_nAI/view?usp=drive_link"
              }
            />
          ) : (
            <CustomChart
